      ...
      <div style={{ display: 'flex', gap: '16px', alignItems: 'center', marginBottom: '8px' }}>
        ...
        <div
          ...
          style={{
            flex: 1,
            height: '80px',
            border: `2px dashed ${isDragOver ? '#007acc' : isLoading ? '#666666' : '#555555'}`,
            borderRadius: '6px',
            backgroundColor: isDragOver ? '#1a3a52' : isLoading ? '#2a2a2a' : '#2d2d30',
            display: 'flex',
        ...
        >
          <div style={{
            ...
            {isLoading ? 'Processing...' : 'File Upload Handler (upload / download)'}
          </div>
          <div style={{
            fontSize: '11px',
            color: '#999999',
        ...
        <button
          ...
          style={{
            height: '80px',
            minWidth: '120px',
            backgroundColor: canDownload ? (hasModifications ? '#0e639c' : '#4a4a4a') : '#3a3a3a',
            border: 'none',
            borderRadius: '6px',
          ...
          onMouseEnter={(e) => {
            if (canDownload) {
              e.currentTarget.style.backgroundColor = hasModifications ? '#1177bb' : '#5a5a5a';
            }
          }}
          onMouseLeave={(e) => {
            if (canDownload) {
              e.currentTarget.style.backgroundColor = hasModifications ? '#0e639c' : '#4a4a4a';
            }
          }}
        >
          <div>Download</div>
          <div style={{ fontSize: '10px', opacity: 0.8 }}>
            {hasModifications ? 'Modified ZIP' : 'Original ZIP'}
          </div>
        </button>
